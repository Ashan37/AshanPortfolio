...
const Contact = ({ isDarkMode }) => {
  ...
  return (
    <div id="contact" className="relative w-full px-[12%] py-10 lg:py-16 scroll-mt-20">
      <h4 className="mb-2 text-lg text-center font-Ovo dark:text-[#FFFFFF]">Connect with me</h4>
      <h2 className="text-4xl text-center sm:text-5xl font-Ovo dark:text-[#01C38D]">
        Get in touch
      </h2>

      <p className="max-w-2xl mx-auto mt-5 mb-12 text-center font-Ovo dark:text-[#FFFFFF]">
